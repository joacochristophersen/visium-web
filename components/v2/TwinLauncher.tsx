      ...
      <div className="relative h-[420px] sm:h-[540px]">
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-5 bg-gradient-to-b from-[#0a0a0e] via-[#080810] to-[#050505]">
          ...
          <button
            ...
            className="group flex items-center gap-3 rounded-full border border-white/20 bg-black/60 px-7 py-4 backdrop-blur-md transition-all duration-300 hover:border-[#D4AF37]/50 hover:bg-[#D4AF37]/[0.08] active:scale-[0.98]"
          >
            <span className="flex h-8 w-8 items-center justify-center rounded-full border border-[#D4AF37]/40 bg-[#D4AF37]/15">
